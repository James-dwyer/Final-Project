void winScreen() {
  ...
  }else {Rectangle quitHover = new Rectangle(width*3/4-width/5, height/2, width/5, height/15, 30);
  Shapes.set(qIndex,quitHover);};
  ...
  }else {Rectangle resHover = new Rectangle(width/4, height/2, width/5, height/15, 30);
  Shapes.set(resIndex,resHover);};
